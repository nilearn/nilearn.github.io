...
</pre></div></div></section><section id=use-in-browser><h2>Use in Browser<a title="Permalink to this heading"class=headerlink href=#use-in-browser>#</a></h2><div class="highlight-html notranslate"><div class=highlight><pre><span></span><span class=p><</span><span class=nt>html</span><span class=p>></span>
<span class=p><</span><span class=nt>head</span><span class=p>></span>
  ...
  <span class=p><</span><span class=nt>script</span> <span class=na>src</span><span class=o>=</span><span class=s>"markdown-it.min.js"</span><span class=p>>&LT/</span><span class=nt>script</span><span class=p>></span>
  <span class=p><</span><span class=nt>script</span> <span class=na>src</span><span class=o>=</span><span class=s>"katex.min.js"</span><span class=p>>&LT/</span><span class=nt>script</span><span class=p>></span>
  <span class=p><</span><span class=nt>script</span> <span class=na>src</span><span class=o>=</span><span class=s>"texmath.js"</span><span class=p>>&LT/</span><span class=nt>script</span><span class=p>></span>
<span class=p>&LT/</span><span class=nt>head</span><span class=p>></span>
<span class=p><</span><span class=nt>body</span><span class=p>></span>
  <span class=p><</span><span class=nt>div</span> <span class=na>id</span><span class=o>=</span><span class=s>"out"</span><span class=p>>&LT/</span><span class=nt>div</span><span class=p>></span>
...
<span class=w>  </span><span class=p>&LT/</span><span class=nt>script</span><span class=p>></span>
...
</pre></div></div></section><section id=cdn><h2>CDN<a title="Permalink to this heading"class=headerlink href=#cdn>#</a></h2><p>Use following links for <code class="docutils literal notranslate"><span class=pre>texmath.js</span></code> and <code class="docutils literal notranslate"><span class=pre>texmath.css</span></code></p><ul class=simple><li><p><code class="docutils literal notranslate"><span class=pre>https://gitcdn.xyz/cdn/goessner/markdown-it-texmath/master/texmath.js</span></code></p></li><li><p><code class="docutils literal notranslate"><span class=pre>https://gitcdn.xyz/cdn/goessner/markdown-it-texmath/master/texmath.css</span></code></p></li></ul></section><section id=dependencies><h2>Dependencies<a title="Permalink to this heading"class=headerlink href=#dependencies>#</a></h2><ul class=simple><li><p><a class="reference external"href=https://github.com/markdown-it/markdown-it><code class="docutils literal notranslate"><span class=pre>markdown-it</span></code></a>: Markdown parser done right. Fast and easy to extend.</p></li><li><p><a class="reference external"href=https://github.com/Khan/KaTeX><code class="docutils literal notranslate"><span class=pre>katex</span></code></a>: This is where credits for fast rendering TeX math in HTML go to.</p></li></ul></section><section id=todo><h2>ToDo<a title="Permalink to this heading"class=headerlink href=#todo>#</a></h2><p>nothing yet</p></section><section id=faq><h2>FAQ<a title="Permalink to this heading"class=headerlink href=#faq>#</a></h2><ul class=simple><li><p><strong><code class="docutils literal notranslate"><span class=pre>markdown-it-texmath</span></code> with React Native does not work, why ?</strong></p> <ul><li><p><code class="docutils literal notranslate"><span class=pre>markdown-it-texmath</span></code> is using regular expressions with <code class="docutils literal notranslate"><span class=pre>y</span></code> <a class="reference external"href=https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/sticky>(sticky) property</a> and cannot avoid this. The use of the <code class="docutils literal notranslate"><span class=pre>y</span></code> flag in regular expressions means the plugin is not compatible with React Native (which as of now doesn’t support it and throws an error <code class="docutils literal notranslate"><span class=pre>Invalid</span> <span class=pre>flags</span> <span class=pre>supplied</span> <span class=pre>to</span> <span class=pre>RegExp</span> <span class=pre>constructor</span></code>).</p></li></ul></li></ul></section><section id=changelog><h2>CHANGELOG<a title="Permalink to this heading"class=headerlink href=#changelog>#</a></h2><section id=on-october-04-2019><h3>[0.6.0] on October 04, 2019<a title="Permalink to this heading"class=headerlink href=#on-october-04-2019>#</a></h3><ul class=simple><li><p>Add support for <a class="reference external"href=https://docs.julialang.org/en/v1/stdlib/Markdown/>Julia Markdown</a> on <a class="reference external"href=https://github.com/goessner/markdown-it-texmath/issues/15>request</a>.</p></li></ul></section><section id=on-february-07-2019><h3>[0.5.5] on February 07, 2019<a title="Permalink to this heading"class=headerlink href=#on-february-07-2019>#</a></h3><ul class=simple><li><p>Remove <a class="reference external"href=https://github.com/goessner/markdown-it-texmath/issues/9>rendering bug with brackets delimiters</a>.</p></li></ul></section><section id=on-january-20-2019><h3>[0.5.4] on January 20, 2019<a title="Permalink to this heading"class=headerlink href=#on-january-20-2019>#</a></h3><ul class=simple><li><p>Remove pathological <a class="reference external"href=https://github.com/goessner/mdmath/issues/50>bug within blockquotes</a>.</p></li></ul></section><section id=on-november-11-2018><h3>[0.5.3] on November 11, 2018<a title="Permalink to this heading"class=headerlink href=#on-november-11-2018>#</a></h3><ul class=simple><li><p>Add support for Tex macros (https://katex.org/docs/supported.html#macros) .</p></li><li><p>Bug with <a class="reference external"href=https://github.com/goessner/markdown-it-texmath/issues/9>brackets delimiters</a> .</p></li></ul></section><section id=on-september-07-2018><h3>[0.5.2] on September 07, 2018<a title="Permalink to this heading"class=headerlink href=#on-september-07-2018>#</a></h3><ul class=simple><li><p>Add support for <a class="reference external"href=https://kramdown.gettalong.org/>Kramdown</a> .</p></li></ul></section><section id=on-august-15-2018><h3>[0.5.0] on August 15, 2018<a title="Permalink to this heading"class=headerlink href=#on-august-15-2018>#</a></h3><ul class=simple><li><p>Fatal blockquote bug investigated. Implemented workaround to vscode bug, which has finally gone with vscode 1.26.0 .</p></li></ul></section><section id=on-january-05-2018><h3>[0.4.6] on January 05, 2018<a title="Permalink to this heading"class=headerlink href=#on-january-05-2018>#</a></h3><ul class=simple><li><p>Escaped underscore bug removed.</p></li></ul></section><section id=on-november-06-2017><h3>[0.4.5] on November 06, 2017<a title="Permalink to this heading"class=headerlink href=#on-november-06-2017>#</a></h3><ul class=simple><li><p>Backslash bug removed.</p></li></ul></section><section id=on-september-27-2017><h3>[0.4.4] on September 27, 2017<a title="Permalink to this heading"class=headerlink href=#on-september-27-2017>#</a></h3><ul class=simple><li><p>Modifying the <code class="docutils literal notranslate"><span class=pre>block</span></code> mode regular expression with <code class="docutils literal notranslate"><span class=pre>gitlab</span></code> delimiters, so removing the <code class="docutils literal notranslate"><span class=pre>newline</span></code> bug.</p></li></ul></section></section><section id=license><h2>License<a title="Permalink to this heading"class=headerlink href=#license>#</a></h2><p><code class="docutils literal notranslate"><span class=pre>markdown-it-texmath</span></code> is licensed under the <a class="reference internal"href=#./license.txt><span class="xref myst">MIT License</span></a></p><p>© <a class="reference external"href=https://github.com/goessner>Stefan Gössner</a></p></section></section></article></div><footer><div class=related-pages></div><div class=bottom-of-page><div class=left-details><div class=copyright>Copyright © The nilearn developers 2010-2022</div> Made with <a href=https://www.sphinx-doc.org/>Sphinx</a> and <a class=muted-link href=https://pradyunsg.me>@pradyunsg</a>'s <a href=https://github.com/pradyunsg/furo>Furo</a></div><div class=right-details></div></div></footer></div><aside class=toc-drawer><div class="toc-sticky toc-scroll"><div class=toc-title-container><span class=toc-title> On this page </span></div><div class=toc-tree-container><div class=toc-tree><ul><li><a class="reference internal"href=#>markdown-it-texmath</a><ul><li><a class="reference internal"href=#features>Features</a></li><li><a class="reference internal"href=#show-me>Show me</a></li><li><a class="reference internal"href=#use-with-node-js>Use with <code class="docutils literal notranslate"><span class=pre>node.js</span></code></a></li><li><a class="reference internal"href=#use-in-browser>Use in Browser</a></li><li><a class="reference internal"href=#cdn>CDN</a></li><li><a class="reference internal"href=#dependencies>Dependencies</a></li><li><a class="reference internal"href=#todo>ToDo</a></li><li><a class="reference internal"href=#faq>FAQ</a></li><li><a class="reference internal"href=#changelog>CHANGELOG</a><ul><li><a class="reference internal"href=#on-october-04-2019>[0.6.0] on October 04, 2019</a></li><li><a class="reference internal"href=#on-february-07-2019>[0.5.5] on February 07, 2019</a></li><li><a class="reference internal"href=#on-january-20-2019>[0.5.4] on January 20, 2019</a></li><li><a class="reference internal"href=#on-november-11-2018>[0.5.3] on November 11, 2018</a></li><li><a class="reference internal"href=#on-september-07-2018>[0.5.2] on September 07, 2018</a></li><li><a class="reference internal"href=#on-august-15-2018>[0.5.0] on August 15, 2018</a></li><li><a class="reference internal"href=#on-january-05-2018>[0.4.6] on January 05, 2018</a></li><li><a class="reference internal"href=#on-november-06-2017>[0.4.5] on November 06, 2017</a></li><li><a class="reference internal"href=#on-september-27-2017>[0.4.4] on September 27, 2017</a></li></ul></li><li><a class="reference internal"href=#license>License</a></li></ul></li></ul></div></div></div></aside></div></div><script data-url_root=../../../../../../ id=documentation_options src=../../../../../../_static/documentation_options.js></script><script src=../../../../../../_static/doctools.js></script><script src=../../../../../../_static/sphinx_highlight.js></script><script src=../../../../../../_static/scripts/furo.js></script><script src=../../../../../../_static/clipboard.min.js></script><script src=../../../../../../_static/copybutton.js></script><script src=../../../../../../_static/design-tabs.js></script></body></html>