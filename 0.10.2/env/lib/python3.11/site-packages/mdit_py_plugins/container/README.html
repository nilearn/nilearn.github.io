...
</pre></div></div><p>Params:</p><ul class=simple><li><p><strong>name</strong> - container name (mandatory)</p></li><li><p><strong>options:</strong></p> <ul><li><p><strong>validate</strong> - optional, function to validate tail after opening marker, should return <code class="docutils literal notranslate"><span class=pre>true</span></code> on success.</p></li><li><p><strong>render</strong> - optional, renderer function for opening/closing tokens.</p></li><li><p><strong>marker</strong> - optional (<code class="docutils literal notranslate"><span class=pre>:</span></code>), character to use in delimiter.</p></li></ul></li></ul></section><section id=example><h2>Example<a title="Permalink to this heading"class=headerlink href=#example>#</a></h2><div class="highlight-js notranslate"><div class=highlight><pre><span></span><span class=kd>var</span><span class=w> </span><span class=nx>md</span><span class=w> </span><span class=o>=</span><span class=w> </span><span class=nx>require</span><span class=p>(</span><span class=s1>'markdown-it'</span><span class=p>)();</span>
...
<span class=w>      </span><span class=k>return</span><span class=w> </span><span class=s1>'&LTdetails>&LTsummary>'</span><span class=w> </span><span class=o>+</span><span class=w> </span><span class=nx>md</span><span class=p>.</span><span class=nx>utils</span><span class=p>.</span><span class=nx>escapeHtml</span><span class=p>(</span><span class=nx>m</span><span class=p>[</span><span class=mf>1</span><span class=p>])</span><span class=w> </span><span class=o>+</span><span class=w> </span><span class=s1>'&LT/summary>\n'</span><span class=p>;</span>

<span class=w>    </span><span class=p>}</span><span class=w> </span><span class=k>else</span><span class=w> </span><span class=p>{</span>
<span class=w>      </span><span class=c1>// closing tag</span>
<span class=w>      </span><span class=k>return</span><span class=w> </span><span class=s1>'&LT/details>\n'</span><span class=p>;</span>
<span class=w>    </span><span class=p>}</span>
<span class=w>  </span><span class=p>}</span>
<span class=p>});</span>
...
<span class=c1>//</span>
<span class=c1>// &LTdetails>&LTsummary>click me&LT/summary></span>
<span class=c1>// &LTp>&LTem>content&LT/em>&LT/p></span>
<span class=c1>// &LT/details></span>
</pre></div></div></section><section id=license><h2>License<a title="Permalink to this heading"class=headerlink href=#license>#</a></h2><p><a class="reference external"href=https://github.com/markdown-it/markdown-it-container/blob/master/LICENSE>MIT</a></p></section></section></article></div><footer><div class=related-pages></div><div class=bottom-of-page><div class=left-details><div class=copyright>Copyright © The nilearn developers 2010-2022</div> Made with <a href=https://www.sphinx-doc.org/>Sphinx</a> and <a class=muted-link href=https://pradyunsg.me>@pradyunsg</a>'s <a href=https://github.com/pradyunsg/furo>Furo</a></div><div class=right-details></div></div></footer></div><aside class=toc-drawer><div class="toc-sticky toc-scroll"><div class=toc-title-container><span class=toc-title> On this page </span></div><div class=toc-tree-container><div class=toc-tree><ul><li><a class="reference internal"href=#>markdown-it-container</a><ul><li><a class="reference internal"href=#installation>Installation</a></li><li><a class="reference internal"href=#api>API</a></li><li><a class="reference internal"href=#example>Example</a></li><li><a class="reference internal"href=#license>License</a></li></ul></li></ul></div></div></div></aside></div></div><script data-url_root=../../../../../../ id=documentation_options src=../../../../../../_static/documentation_options.js></script><script src=../../../../../../_static/doctools.js></script><script src=../../../../../../_static/sphinx_highlight.js></script><script src=../../../../../../_static/scripts/furo.js></script><script src=../../../../../../_static/clipboard.min.js></script><script src=../../../../../../_static/copybutton.js></script><script src=../../../../../../_static/design-tabs.js></script></body></html>