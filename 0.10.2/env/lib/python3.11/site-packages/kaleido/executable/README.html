...
<meta property="og:url" content="https://nilearn.github.io/env/lib/python3.11/site-packages/kaleido/executable/README.html" />
<meta property="og:site_name" content="Nilearn" />
<meta property="og:description" content="Kaleido is a cross-platform library for generating static images (e.g. png, svg, pdf, etc.) for web-based visualization libraries, with a particular focus on eliminating external dependencies. The ..." />
<meta property="og:image" content="https://user-images.githubusercontent.com/15064365/101241780-3590b580-36c7-11eb-8eba-eb1fae256ad0.png" />
<meta property="og:image:alt" content="fig" />
<meta name="description" content="Kaleido is a cross-platform library for generating static images (e.g. png, svg, pdf, etc.) for web-based visualization libraries, with a particular focus on eliminating external dependencies. The ..." />
<link rel="search" title="Search" href="../../../../../../search.html" />

    <link rel="shortcut icon" href="../../../../../../_static/favicon.ico"/><!-- Generated with Sphinx 6.2.1 and Furo 2023.05.20 -->
        <title>Overview - Nilearn</title>
...
<div class="announcement">
  <aside class="announcement-content">
     <p>This is the development documentation of nilearn (0.10.2.dev44+g93562277d) <a class="sd-sphinx-override sd-badge sd-text-wrap sd-btn-outline-dark reference external" href="https://nilearn.github.io"><span>Switch to stable version (0.10.1)</span></a></p> 
  </aside>
</div>
...
<p>Kaleido is a cross-platform library for generating static images (e.g. png, svg, pdf, etc.) for web-based visualization libraries, with a particular focus on eliminating external dependencies. The project’s initial focus is on the export of plotly.js images from Python for use by plotly.py, but it is designed to be relatively straight-forward to extend to other web-based visualization libraries, and other programming languages.  The primary focus of Kaleido (at least initially) is to serve as a dependency of web-based visualization libraries like plotly.py. As such, the focus is on providing a programmatic-friendly, rather than user-friendly, API.</p>
</section>
<section id="installing-kaleido">
<h1>Installing Kaleido<a class="headerlink" href="#installing-kaleido" title="Permalink to this heading">#</a></h1>
<p>The kaleido package can be installed from <a class="reference external" href="https://pypi.org/">PyPI</a> using pip…</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ pip install kaleido
</pre></div>
</div>
<p>or from <a class="reference external" href="https://conda-forge.org/">conda-forge</a> using conda.</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ conda install -c conda-forge python-kaleido
</pre></div>
</div>
<p>Releases of the core kaleido C++ executable are attached as assets to GitHub releases at https://github.com/plotly/Kaleido/releases.</p>
</section>
<section id="use-kaleido-to-export-plotly-py-figures-as-static-images">
<h1>Use Kaleido to export plotly.py figures as static images<a class="headerlink" href="#use-kaleido-to-export-plotly-py-figures-as-static-images" title="Permalink to this heading">#</a></h1>
<p>Versions 4.9 and above of the Plotly Python library will automatically use kaleido for static image export when kaleido is installed. For example:</p>
...
<p>Then, open <code class="docutils literal notranslate"><span class="pre">figure.png</span></code> in the current working directory.</p>
<p><img alt="fig" src="https://user-images.githubusercontent.com/15064365/101241780-3590b580-36c7-11eb-8eba-eb1fae256ad0.png" /></p>
<p>See the plotly static image export documentation for more information: https://plotly.com/python/static-image-export/.</p>
</section>
<section id="low-level-kaleido-scope-developer-api">
<h1>Low-level Kaleido Scope Developer API<a class="headerlink" href="#low-level-kaleido-scope-developer-api" title="Permalink to this heading">#</a></h1>
<p>The kaleido Python package provides a low-level Python API that is designed to be used by high-level plotting libraries like Plotly.  Here is an example of exporting a Plotly figure using the low-level Kaleido API:</p>
<blockquote>
<div><p>Note: This particular example uses an online copy of the plotly JavaScript library from a CDN location, so it will not work without an internet connection.  When the plotly Python library uses Kaleido (as in the example above), it provides the path to its own local offline copy of plotly.js and so no internet connection is required.</p>
</div></blockquote>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">kaleido.scopes.plotly</span> <span class="kn">import</span> <span class="n">PlotlyScope</span>
...
<p>Then, open <code class="docutils literal notranslate"><span class="pre">figure.png</span></code> in the current working directory.</p>
<p><img alt="figure" src="https://user-images.githubusercontent.com/15064365/86343448-f8f7f400-bc26-11ea-9191-6803748c2dc9.png" /></p>
</section>
<section id="background">
<h1>Background<a class="headerlink" href="#background" title="Permalink to this heading">#</a></h1>
<p>As simple as it sounds, programmatically generating static images (e.g. raster images like PNGs or vector images like SVGs) from web-based visualization libraries (e.g. Plotly.js, Vega-Lite, etc.) is a complex problem.  It’s a problem that library developers have struggled with for years, and it has delayed the adoption of these libraries among scientific communities that rely on print-based publications for sharing their research. The core difficulty is that web-based visualization libraries don’t actually render plots (i.e. color the pixels) on their own, instead they delegate this work to web technologies like SVG, Canvas, WebGL, etc. Similar to how Matplotlib relies on various backends to display figures, web-based visualization libraries rely on a web browser rendering engine to display figures.</p>
<p>When the figure is displayed in a browser window, it’s relatively straight-forward for a visualization library to provide an export-image button because it has full access to the browser for rendering.  The difficulty arises when trying to export an image programmatically (e.g. from Python) without displaying it in a browser and without user interaction.  To accomplish this, the Python portion of the visualization library needs programmatic access to a web browser’s rendering engine.</p>
<p>There are three main approaches that are currently in use among Python web-based visualization libraries:</p>
<ol class="arabic simple">
<li><p>Bokeh, Altair, bqplot, and ipyvolume rely on the Selenium Python library to control a system web browser such as Firefox or Chrome/Chromium to perform image rendering.</p></li>
<li><p>plotly.py relies on Orca, which is a custom headless Electron application that uses the Chromium browser engine built into Electron to perform image rendering. Orca runs as a local web server and plotly.py sends requests to it using a local port.</p></li>
<li><p>When operating in the Jupyter notebook or JupyterLab, ipyvolume also supports programmatic image export by sending export requests to the browser using the ipywidgets protocol.</p></li>
</ol>
<p>While approaches 1 and 2 can both be installed using conda, they still rely on all of the system dependencies of a complete web browser, even the parts that aren’t actually necessary for rendering a visualization. For example, on Linux both require the installation of system libraries related to audio (libasound.so), video (libffmpeg.so), GUI toolkit (libgtk-3.so), screensaver (libXss.so), and X11 (libX11-xcb.so) support. Many of these are not typically included in headless Linux installations like you find in JupyterHub, Binder, Colab, Azure notebooks, SageMaker, etc. Also, conda is still not as universally available as the pip package manager and neither approach is installable using pip packages.</p>
<p>Additionally, both 1 and 2 communicate between the Python process and the web browser over a local network port. While not typically a problem, certain firewall and container configurations can interfere with this local network connection.</p>
<p>The advantage of options 3 is that it introduces no additional system dependencies. The disadvantage is that it only works when running in a notebook, so it can’t be used in standalone Python scripts.</p>
<p>The end result is that all of these libraries have in-depth documentation pages on how to get image export working, and how to troubleshoot the inevitable failures and edge cases. While this is a great improvement over the state of affairs just a couple of years ago, and a lot of excellent work has gone into making these approaches work as seamlessly as possible, the fundamental limitations detailed above still result in sub-optimal user experiences. This is especially true when comparing web-based plotting libraries to traditional plotting libraries like matplotlib and ggplot2 where there’s never a question of whether image export will work in a particular context.</p>
<p>The goal of the Kaleido project is to make static image export of web-based visualization libraries as universally available and reliable as it is in matplotlib and ggplot2.</p>
</section>
<section id="approach">
<h1>Approach<a class="headerlink" href="#approach" title="Permalink to this heading">#</a></h1>
<p>To accomplish this goal, Kaleido introduces a new approach. The core of Kaleido is a standalone C++ application that embeds the open-source Chromium browser as a library. This architecture allows Kaleido to communicate with the Chromium browser engine using the C++ API rather than requiring a local network connection. A thin Python wrapper runs the Kaleido C++ application as a subprocess and communicates with it by writing image export requests to standard-in and retrieving results by reading from standard-out.  Other language wrappers (e.g. R, Julia, Scala, Rust, etc.) can fairly easily be written in the future because the interface relies only on standard-in / standard-out communication using JSON requests.</p>
<p>By compiling Chromium as a library, we have a degree of control over what is included in the Chromium build. In particular, on Linux we can build Chromium in <a class="reference external" href="https://chromium.googlesource.com/chromium/src/+/lkgr/headless/README.md#usage-as-a-c_library">headless</a> mode which eliminates a large number of runtime dependencies, including the audio, video, GUI toolkit, screensaver, and X11 dependencies mentioned above. The remaining dependencies can then be bundled with the library, making it possible to run Kaleido in minimal Linux environments with no additional dependencies required. In this way, Kaleido can be distributed as a self-contained library that plays a similar role to a matplotlib backend.</p>
</section>
<section id="advantages">
<h1>Advantages<a class="headerlink" href="#advantages" title="Permalink to this heading">#</a></h1>
<p>Compared to Orca, Kaleido brings a wide range of improvements to plotly.py users.</p>
<section id="pip-installation-support">
<h2>pip installation support<a class="headerlink" href="#pip-installation-support" title="Permalink to this heading">#</a></h2>
<p>Pre-compiled wheels for 64-bit Linux, MacOS, and Windows are available on PyPI and can be installed using pip. As with Orca, Kaleido can also be installed using conda.</p>
</section>
<section id="improved-startup-time-and-resource-usage">
<h2>Improved startup time and resource usage<a class="headerlink" href="#improved-startup-time-and-resource-usage" title="Permalink to this heading">#</a></h2>
<p>Kaleido starts up about twice as fast as Orca, and uses about half as much system memory.</p>
</section>
<section id="docker-compatibility">
<h2>Docker compatibility<a class="headerlink" href="#docker-compatibility" title="Permalink to this heading">#</a></h2>
<p>Kaleido can operate inside docker containers based on Ubuntu 14.04+ or Centos 7+ (or most any other Linux distro released after ~2014) without the need to install additional dependencies using apt or yum, and without relying on Xvfb as a headless X11 Server.</p>
</section>
<section id="hosted-notebook-service-compatibility">
<h2>Hosted notebook service compatibility<a class="headerlink" href="#hosted-notebook-service-compatibility" title="Permalink to this heading">#</a></h2>
<p>Kaleido can be used in just about any online notebook service that permits the use of pip to install the kaleido package. These include Colab, Sagemaker, Azure Notebooks, Databricks, Kaggle, etc. In addition, Kaleido is compatible with the default Docker image used by Binder.</p>
</section>
<section id="security-policy-firewall-compatibility">
<h2>Security policy / Firewall compatibility<a class="headerlink" href="#security-policy-firewall-compatibility" title="Permalink to this heading">#</a></h2>
<p>There were occasionally situations where strict security policies and/or firewall services would block Orca’s ability to bind to a local port. Kaleido does not have this limitation since it does not use ports for communication.</p>
</section>
</section>
<section id="disadvantages">
<h1>Disadvantages<a class="headerlink" href="#disadvantages" title="Permalink to this heading">#</a></h1>
<p>While this approach has many advantages, the main disadvantage is that building Chromium is not for the faint of heart.  Even on powerful workstations, downloading and building the Chromium code base takes 50+ GB of disk space and several hours.  On Linux this work can be done once and distributed as a large docker container, but we don’t have a similar shortcut for Windows and MacOS.</p>
</section>
<section id="scope-plugin-architecture">
<h1>Scope (Plugin) architecture<a class="headerlink" href="#scope-plugin-architecture" title="Permalink to this heading">#</a></h1>
<p>While motivated by the needs of plotly.py, we made the decision early on to design Kaleido to make it fairly straightforward to add support for additional libraries.  Plugins in Kaleido are called “scopes”. For more information, see https://github.com/plotly/Kaleido/wiki/Scope-(Plugin)-Architecture.</p>
</section>
<section id="language-wrapper-architecture">
<h1>Language wrapper architecture<a class="headerlink" href="#language-wrapper-architecture" title="Permalink to this heading">#</a></h1>
<p>While Python is the initial target language for Kaleido, it has been designed to make it fairly straightforward to add support for additional languages. For more information, see https://github.com/plotly/Kaleido/wiki/Language-wrapper-architecture.</p>
</section>
<section id="building-kaleido">
<h1>Building Kaleido<a class="headerlink" href="#building-kaleido" title="Permalink to this heading">#</a></h1>
<p>Instructions for building Kaleido differ slightly across operating systems.  All of these approaches assume that the Kaleido repository has been cloned and that the working directory is set to the repository root.</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ git clone git@github.com:plotly/Kaleido.git
$ cd Kaleido
</pre></div>
</div>
<section id="linux">
<h2>Linux<a class="headerlink" href="#linux" title="Permalink to this heading">#</a></h2>
<p>There are two approaches to building Kaleido on Linux, both of which rely on Docker.</p>
<p>The Linux build relies on the <code class="docutils literal notranslate"><span class="pre">jonmmease/chromium-builder</span></code> docker image, and the scripts in <code class="docutils literal notranslate"><span class="pre">repos/linux_scripts</span></code>, to download the chromium source to a local folder and then build it.
Download docker image</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ docker pull jonmmease/chromium-builder:0.8
</pre></div>
</div>
<p>Fetch the Chromium codebase and checkout the specific tag, then sync all dependencies</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ /repos/linux_scripts/fetch_chromium
</pre></div>
</div>
<p>Then build the <code class="docutils literal notranslate"><span class="pre">kaleido</span></code> application to <code class="docutils literal notranslate"><span class="pre">repos/build/kaleido</span></code>, and bundle shared libraries and fonts. The input source for this application is stored under <code class="docutils literal notranslate"><span class="pre">repos/kaleido/cc/</span></code>. The build step will also
create the Python wheel under <code class="docutils literal notranslate"><span class="pre">repos/kaleido/py/dist/</span></code></p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ /repos/linux_scripts/build_kaleido x64
</pre></div>
</div>
<p>The above command will build Kaleido for the 64-bit Intel architecture. Kaleido can also be build for 64-bit ARM architecture with</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ /repos/linux_scripts/build_kaleido arm64
</pre></div>
</div>
</section>
<section id="macos">
<h2>MacOS<a class="headerlink" href="#macos" title="Permalink to this heading">#</a></h2>
<p>To build on MacOS, first install XCode version 11.0+, nodejs 12, and Python 3.  See https://chromium.googlesource.com/chromium/src/+/master/docs/mac_build_instructions.md for more information on build requirements.</p>
<p>Then fetch the chromium codebase</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ /repos/mac_scripts/fetch_chromium
</pre></div>
</div>
<p>Then build Kaleido to <code class="docutils literal notranslate"><span class="pre">repos/build/kaleido</span></code>. The build step will also create the Python wheel under <code class="docutils literal notranslate"><span class="pre">repos/kaleido/py/dist/</span></code></p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ /repos/mac_scripts/build_kaleido
</pre></div>
</div>
</section>
<section id="windows">
<h2>Windows<a class="headerlink" href="#windows" title="Permalink to this heading">#</a></h2>
<p>To build on Windows, first install Visual Studio 2019 (community edition is fine), nodejs 12, and Python 3. See https://chromium.googlesource.com/chromium/src/+/master/docs/windows_build_instructions.md for more information on build requirements.</p>
<p>Then fetch the chromium codebase from a Power Shell command prompt</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ /repos/win_scripts/fetch_chromium.ps1
</pre></div>
</div>
<p>Then build Kaleido to <code class="docutils literal notranslate"><span class="pre">repos/build/kaleido</span></code>. The build step will also create the Python wheel under <code class="docutils literal notranslate"><span class="pre">repos/kaleido/py/dist/</span></code></p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ /repos/mac_scripts/build_kaleido.ps1 x64
</pre></div>
</div>
<p>The above commnad will generate a 64-bit build. A 32-bit build can be generated using</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ /repos/mac_scripts/build_kaleido.ps1 x86
</pre></div>
</div>
</section>
</section>
<section id="building-docker-containers">
<h1>Building Docker containers<a class="headerlink" href="#building-docker-containers" title="Permalink to this heading">#</a></h1>
<section id="chromium-builder">
<h2>chromium-builder<a class="headerlink" href="#chromium-builder" title="Permalink to this heading">#</a></h2>
<p>The <code class="docutils literal notranslate"><span class="pre">chromium-builder</span></code> container mostly follows the instructions at https://chromium.googlesource.com/chromium/src/+/master/docs/linux/build_instructions.md to install <code class="docutils literal notranslate"><span class="pre">depot_tools</span></code> and run <code class="docutils literal notranslate"><span class="pre">install-build-deps.sh</span></code> to install the required build dependencies the appropriate stable version of Chromium. The image is based on ubuntu 16.04, which is the recommended OS for building Chromium on Linux.</p>
<p>Build container with:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ docker build -t jonmmease/chromium-builder:0.8 -f repos/linux_scripts/Dockerfile .
</pre></div>
</div>
</section>
<section id="kaleido-builder">
<h2>kaleido-builder<a class="headerlink" href="#kaleido-builder" title="Permalink to this heading">#</a></h2>
<p>This container contains a pre-compiled version of chromium source tree. Takes several hours to build!</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ docker build -t jonmmease/kaleido-builder:0.8 -f repos/linux_full_scripts/Dockerfile .
</pre></div>
</div>
</section>
</section>
<section id="updating-chromium-version">
<h1>Updating chromium version<a class="headerlink" href="#updating-chromium-version" title="Permalink to this heading">#</a></h1>
<p>To update the version of Chromium in the future, the docker images will need to be updated. Follow the instructions for the <code class="docutils literal notranslate"><span class="pre">DEPOT_TOOLS_COMMIT</span></code> and <code class="docutils literal notranslate"><span class="pre">CHROMIUM_TAG</span></code> environment variables in <code class="docutils literal notranslate"><span class="pre">linux_scripts/Dockerfile</span></code>.</p>
<blockquote>
<div><p>Find a stable chromium version tag from https://chromereleases.googleblog.com/search/label/Desktop%20Update. Look up date of associated tag in GitHub at https://github.com/chromium/chromium/
E.g. Stable chrome version tag on 05/19/2020: 83.0.4103.61, set <code class="docutils literal notranslate"><span class="pre">CHROMIUM_TAG=&quot;83.0.4103.61&quot;</span></code></p>
<p>Search through depot_tools commitlog (https://chromium.googlesource.com/chromium/tools/depot_tools/+log) for commit hash of commit from the same day.
E.g. depot_tools commit hash from 05/19/2020: e67e41a, set <code class="docutils literal notranslate"><span class="pre">DEPOT_TOOLS_COMMIT=e67e41a</span></code></p>
</div></blockquote>
...
<p>The CMakeLists.txt file in <code class="docutils literal notranslate"><span class="pre">repos/</span></code> is only there to help IDE’s like <code class="docutils literal notranslate"><span class="pre">CLion</span></code>/<code class="docutils literal notranslate"><span class="pre">KDevelop</span></code> figure out how to index the chromium source tree. It can’t be used to actually build chromium. Using this approach, it’s possible to get full completion and code navigation from <code class="docutils literal notranslate"><span class="pre">repos/kaleido/cc/kaleido.cc</span></code> in CLion.</p>
</section>
