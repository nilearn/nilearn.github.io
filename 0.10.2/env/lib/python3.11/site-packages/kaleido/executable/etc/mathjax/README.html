...
<meta property="og:url" content="https://nilearn.github.io/env/lib/python3.11/site-packages/kaleido/executable/etc/mathjax/README.html" />
<meta property="og:site_name" content="Nilearn" />
<meta property="og:description" content="Beautiful math in all browsers: MathJax is an open-source JavaScript display engine for LaTeX, MathML, and AsciiMath notation that works in all modern browsers. It was designed with the goal of con..." />
...
<meta name="description" content="Beautiful math in all browsers: MathJax is an open-source JavaScript display engine for LaTeX, MathML, and AsciiMath notation that works in all modern browsers. It was designed with the goal of con..." />
<link rel="search" title="Search" href="../../../../../../../../search.html" />

    <link rel="shortcut icon" href="../../../../../../../../_static/favicon.ico"/><!-- Generated with Sphinx 6.2.1 and Furo 2023.05.20 -->
        <title>MathJax - Nilearn</title>
...
<div class="theme-toggle-container theme-toggle-content">
        ...
        <article role="main">
          <section id="mathjax">
<h1>MathJax<a class="headerlink" href="#mathjax" title="Permalink to this heading">#</a></h1>
<section id="beautiful-math-in-all-browsers">
<h2>Beautiful math in all browsers<a class="headerlink" href="#beautiful-math-in-all-browsers" title="Permalink to this heading">#</a></h2>
<p>MathJax is an open-source JavaScript display engine for LaTeX, MathML, and
...
mathematics in a web page, and MathJax does the rest.</p>
...
<li><p>Supported in most browsers with no plug-ins, extra fonts, or special
setup for the reader</p></li>
<li><p>Easy for authors, flexible for publishers, extensible for developers</p></li>
<li><p>Supports math accessibility, cut-and-paste interoperability, and other
advanced functionality</p></li>
<li><p>Powerful API for integration with other web applications</p></li>
</ul>
<p>See <a class="reference external" href="http://www.mathjax.org/">http://www.mathjax.org/</a> for additional details.</p>
</section>
...
<p>The MathJax installation and usage documentation is available in a
separate GitHub repository at <a class="reference external" href="https://github.com/mathjax/mathjax-docs">https://github.com/mathjax/mathjax-docs</a>.
The HTML versions can now be viewed at <a class="reference external" href="http://docs.mathjax.org/">http://docs.mathjax.org/</a>,
where it is possible for you to submit corrections and modifications
directly to the documentation on line.</p>
</section>
<section id="community">
<h2>Community<a class="headerlink" href="#community" title="Permalink to this heading">#</a></h2>
<p>The main MathJax website is <a class="reference external" href="http://www.mathjax.org">http://www.mathjax.org</a>, and it includes
announcements and other important information.  MathJax is maintained and
distributed on GitHub at <a class="reference external" href="http://github.com/mathjax/MathJax">http://github.com/mathjax/MathJax</a>.  A user forum
for asking questions and getting assistance is hosted at Google, and the
bug tracker is hosted at GitHub:</p>
<p>Bug tracker:         <a class="reference external" href="https://github.com/mathjax/MathJax/issues">https://github.com/mathjax/MathJax/issues</a><br />
MathJax-Users Group: <a class="reference external" href="http://groups.google.com/group/mathjax-users">http://groups.google.com/group/mathjax-users</a></p>
<p>Before reporting a bug, please check that it has not already been reported.
Also, please use the bug tracker for reporting bugs rather than the help forum.</p>
</section>
</section>
...
<li><a class="reference internal" href="#beautiful-math-in-all-browsers">Beautiful math in all browsers</a></li>
