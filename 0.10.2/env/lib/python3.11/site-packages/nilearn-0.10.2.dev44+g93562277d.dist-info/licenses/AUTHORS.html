...
<meta property="og:url" content="https://nilearn.github.io/env/lib/python3.11/site-packages/nilearn-0.10.2.dev44%2Bg93562277d.dist-info/licenses/AUTHORS.html" />
<meta property="og:site_name" content="Nilearn" />
<meta property="og:description" content="This work is made available by a community of people, which originated from the INRIA MIND Project Team and scikit-learn but grew much further. An up-to-date list of contributors can be seen in on ..." />
<meta property="og:image" content="https://nilearn.github.io/env/lib/python3.11/site-packages/nilearn-0.10.2.dev44%2Bg93562277d.dist-info/licenses/env/lib/python3.11/site-packages/nilearn-0.10.2.dev44+g93562277d.dist-info/licenses/logos/hbp-logo.png" />
<meta property="og:image:alt" content="HBP Logo" />
<meta name="description" content="This work is made available by a community of people, which originated from the INRIA MIND Project Team and scikit-learn but grew much further. An up-to-date list of contributors can be seen in on ..." />
<link rel="search" title="Search" href="../../../../../../search.html" />

    <link rel="shortcut icon" href="../../../../../../_static/favicon.ico"/><!-- Generated with Sphinx 6.2.1 and Furo 2023.05.20 -->
        <title>Team - Nilearn</title>
...
<div class="theme-toggle-container theme-toggle-content">
        ...
        <article role="main">
          <section id="team">
<h1>Team<a class="headerlink" href="#team" title="Permalink to this heading">#</a></h1>
<p>This work is made available by a community of people, which
originated from
the <a class="reference external" href="https://team.inria.fr/mind">INRIA MIND Project Team</a> and <a class="reference external" href="https://scikit-learn.org/stable/">scikit-learn</a>
but grew much further.</p>
<p>An up-to-date list of contributors can be seen in on
<a class="reference external" href="https://github.com/nilearn/nilearn/graphs/contributors">GitHub</a>.</p>
<p>Additional credit goes to <a href="#id1"><span class="problematic" id="id2">`Michael Hanke`_</span></a> and <a href="#id3"><span class="problematic" id="id4">`Yaroslav Halchenko`_</span></a> for data and packaging.</p>
<section id="core-developers">
<span id="core-devs"></span><h2>Core developers<a class="headerlink" href="#core-developers" title="Permalink to this heading">#</a></h2>
<p>The nilearn core developers are:</p>
<ul class="simple">
<li><p><a href="#id5"><span class="problematic" id="id6">`Alexis Thual`_</span></a></p></li>
<li><p><a href="#id7"><span class="problematic" id="id8">`Bertrand Thirion`_</span></a></p></li>
<li><p><a href="#id9"><span class="problematic" id="id10">`Elizabeth DuPre`_</span></a></p></li>
<li><p><a href="#id11"><span class="problematic" id="id12">`Hao-Ting Wang`_</span></a></p></li>
<li><p><a href="#id13"><span class="problematic" id="id14">`Jerome Dockes`_</span></a></p></li>
<li><p><a href="#id15"><span class="problematic" id="id16">`Nicolas Gensollen`_</span></a></p></li>
<li><p><a href="#id17"><span class="problematic" id="id18">`Rémi Gau`_</span></a></p></li>
<li><p><a href="#id19"><span class="problematic" id="id20">`Taylor Salo`_</span></a></p></li>
<li><p><a href="#id21"><span class="problematic" id="id22">`Yasmin Mzayek`_</span></a></p></li>
</ul>
</section>
<section id="other-contributors">
<h2>Other contributors<a class="headerlink" href="#other-contributors" title="Permalink to this heading">#</a></h2>
<p>Some other past or present contributors are:</p>
<ul class="simple">
<li><p><a href="#id23"><span class="problematic" id="id24">`Alexandre Gramfort`_</span></a></p></li>
<li><p><a href="#id25"><span class="problematic" id="id26">`Binh Nguyen`_</span></a></p></li>
<li><p><a href="#id27"><span class="problematic" id="id28">`Gael Varoquaux`_</span></a></p></li>
<li><p><a href="#id29"><span class="problematic" id="id30">`Julia Huntenburg`_</span></a></p></li>
<li><p><a href="#id31"><span class="problematic" id="id32">`Thomas Bazeille`_</span></a></p></li>
<li><p><a href="#id33"><span class="problematic" id="id34">`Alexandre Abadie`_</span></a></p></li>
<li><p><a href="#id35"><span class="problematic" id="id36">`Alexandre Abraham`_</span></a></p></li>
<li><p><a href="#id37"><span class="problematic" id="id38">`Andrés Hoyos Idrobo`_</span></a></p></li>
<li><p><a href="#id39"><span class="problematic" id="id40">`Ben Cipollini`_</span></a></p></li>
<li><p><a href="#id41"><span class="problematic" id="id42">`Chris Gorgolewski`_</span></a></p></li>
<li><p><a href="#id43"><span class="problematic" id="id44">`Danilo Bzdok`_</span></a></p></li>
<li><p><a href="#id45"><span class="problematic" id="id46">`Elvis Dohmatob`_</span></a></p></li>
<li><p><a href="#id47"><span class="problematic" id="id48">`Fabian Pedregosa`_</span></a></p></li>
<li><p><a href="#id49"><span class="problematic" id="id50">`Jean Kossaifi`_</span></a></p></li>
<li><p><a href="#id51"><span class="problematic" id="id52">`Jerome-Alexis Chevalier`_</span></a></p></li>
<li><p><a href="#id53"><span class="problematic" id="id54">`Kamalakar Reddy Daddy`_</span></a></p></li>
<li><p><a href="#id55"><span class="problematic" id="id56">`Kshitij Chawla`_</span></a></p></li>
<li><p><a href="#id57"><span class="problematic" id="id58">`Loic Estève`_</span></a></p></li>
<li><p><a href="#id59"><span class="problematic" id="id60">`Martin Perez-Guevara`_</span></a></p></li>
<li><p><a href="#id61"><span class="problematic" id="id62">`Michael Eickenberg`_</span></a></p></li>
<li><p><a href="#id63"><span class="problematic" id="id64">`Philippe Gervais`_</span></a></p></li>
<li><p><a href="#id65"><span class="problematic" id="id66">`Pierre Bellec`_</span></a></p></li>
<li><p><a href="#id67"><span class="problematic" id="id68">`Salma Bougacha`_</span></a></p></li>
<li><p><a href="#id69"><span class="problematic" id="id70">`Vincent Michel`_</span></a></p></li>
<li><p><a href="#id71"><span class="problematic" id="id72">`Virgile Fritsch`_</span></a></p></li>
</ul>
</section>
<section id="funding">
<h2>Funding<a class="headerlink" href="#funding" title="Permalink to this heading">#</a></h2>
<p><a href="#id73"><span class="problematic" id="id74">`Rémi Gau`_</span></a> is paid by a grant from the
<a class="reference external" href="https://chanzuckerberg.com/eoss/proposals/improving-standard-practice-for-neuroimaging-analyses-with-nilearn/">Chan Zuckerberg Initiative</a></p>
<p><a href="#id75"><span class="problematic" id="id76">`Alexandre Abraham`_</span></a>, <a href="#id77"><span class="problematic" id="id78">`Gael Varoquaux`_</span></a>, <a href="#id79"><span class="problematic" id="id80">`Kamalakar Reddy Daddy`_</span></a>, <a href="#id81"><span class="problematic" id="id82">`Loic Estève`_</span></a>,
<a href="#id83"><span class="problematic" id="id84">`Mehdi Rahim`_</span></a>, <a href="#id85"><span class="problematic" id="id86">`Philippe Gervais`_</span></a> were paid by the
<a class="reference external" href="https://team.inria.fr/parietal/research/spatial_patterns/niconnect/">NiConnect</a>.
project, funded by the French <a class="reference external" href="http://www.gouvernement.fr/investissements-d-avenir-cgi">Investissement d’Avenir</a>.</p>
<p><a href="#id87"><span class="problematic" id="id88">`Kshitij Chawla`_</span></a> was paid by <a class="reference external" href="https://www.inria.fr/en">INRIA</a>.</p>
<p><a href="#id89"><span class="problematic" id="id90">`Yasmin Mzayek`_</span></a> is paid by the <a class="reference external" href="https://www.humanbrainproject.eu/en/">Human Brain Project</a>
<a class="reference internal" href="env/lib/python3.11/site-packages/nilearn-0.10.2.dev44+g93562277d.dist-info/licenses/logos/hbp-logo.png"><img alt="HBP Logo" src="env/lib/python3.11/site-packages/nilearn-0.10.2.dev44+g93562277d.dist-info/licenses/logos/hbp-logo.png" style="height: 25px;" /></a>. Previously <a href="#id91"><span class="problematic" id="id92">`Nicolas Gensollen`_</span></a> was funded by HBP.</p>
<p>NiLearn is also supported by <a class="reference external" href="https://digicosme.lri.fr">DigiCosme</a>
<a class="reference internal" href="env/lib/python3.11/site-packages/nilearn-0.10.2.dev44+g93562277d.dist-info/licenses/logos/digi-saclay-logo-small.png"><img alt="DigiComse Logo" src="env/lib/python3.11/site-packages/nilearn-0.10.2.dev44+g93562277d.dist-info/licenses/logos/digi-saclay-logo-small.png" style="height: 25px;" /></a> and <a class="reference external" href="https://dataia.eu/en">DataIA</a> <a class="reference internal" href="env/lib/python3.11/site-packages/nilearn-0.10.2.dev44+g93562277d.dist-info/licenses/logos/dataia.png"><img alt="DataIA Logo" src="env/lib/python3.11/site-packages/nilearn-0.10.2.dev44+g93562277d.dist-info/licenses/logos/dataia.png" style="height: 25px;" /></a>.</p>
<section id="citing-nilearn">
<span id="citing"></span><h3>Citing nilearn<a class="headerlink" href="#citing-nilearn" title="Permalink to this heading">#</a></h3>
<p>There is no paper published yet about nilearn. We are waiting for the
package to mature a bit. However, the patterns underlying the package
have been described in: <a class="reference external" href="http://journal.frontiersin.org/article/10.3389/fninf.2014.00014/abstract">Machine learning for neuroimaging with
scikit-learn</a>.</p>
<p>We suggest that you read and cite the paper. Thank you.</p>
</section>
...
<p>A huge amount of work goes into <a class="reference external" href="https://scikit-learn.org/stable/">scikit-learn</a>,
...
In addition, the <a class="reference external" href="https://team.inria.fr/mind">INRIA MIND Project Team</a> needs citations
to the paper in order to justify paying a software engineer on the project.
To guarantee the future of the toolkit, if you use it, please cite it.</p>
<p>See the scikit-learn documentation on
<a class="reference external" href="https://scikit-learn.org/stable/about.html#citing-scikit-learn">how to cite</a>.</p>
</section>
</section>
</section>
    ...
    <aside class="toc-drawer">
      ...
      <div class="toc-sticky toc-scroll">
        ...
        <div class="toc-tree-container">
          <div class="toc-tree">
            <ul>
<li><a class="reference internal" href="#">Team</a><ul>
...
<li><a class="reference internal" href="#citing-nilearn">Citing nilearn</a></li>
